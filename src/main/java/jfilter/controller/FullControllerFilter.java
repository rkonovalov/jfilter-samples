...
public class FullControllerFilter {
    ...
    /**
     * Get user address details by role using xml config
     *
    ...
    public Address getUserAddressByRole(@PathVariable(name = "id") Integer id, @RequestParam(name = "role") String role, HttpSession session) {
